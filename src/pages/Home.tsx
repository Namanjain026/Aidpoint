...
<!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-3WPM6WKDSJ"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
  
    gtag('config', 'G-3WPM6WKDSJ');
  </script>
  const features = [
    {
      ...
      description:
        "Search and compare hospitals by location, specialization, and ratings with real-time availability",
    ...
    },
    {
      ...
      title: "Book Doctors",
      description:
        "Browse verified doctor profiles and book appointments with specialists instantly",
    ...
    },
    {
      ...
      description:
        "AI-powered appointment management with automated reminders and rescheduling",
    ...
    },
    {
      ...
      description:
        "Seamless insurance verification and cost estimation for all treatments",
  ...
  const services = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1551076805-e1869033e561?w=600&h=400&fit=crop&crop=faces",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=600&h=400&fit=crop&crop=faces",
      features: [
    ...
    },
    {
      ...
      image:
        "https://plus.unsplash.com/premium_photo-1726769176212-1ab1fd60f42a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  const testimonials = [
    {
      ...
      role: "Patient",
      content:
        "AidPoint made finding the right specialist so easy. The interface is intuitive and booking was seamless!",
      rating: 5,
    },
    {
      ...
      role: "Cardiologist",
      content:
        "The platform streamlined our patient management significantly. Highly recommended for healthcare providers.",
      rating: 5,
    },
    {
      ...
      content:
        "Our patient satisfaction improved dramatically after integrating with AidPoint's system.",
      rating: 5,
    },
  ];

  const themeClasses =
    "bg-gradient-to-br from-blue-200 via-indigo-300 to-purple-300";
  ...
  return (
    <div
      className={`min-h-screen transition-all duration-500 ${themeClasses} relative overflow-x-hidden`}
    >
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-10 md:mb-0">
                <div className="opacity-0 animate-fade-in">
                  <div className="inline-flex items-center px-4 py-2 backdrop-blur-xl bg-white/80 border border-blue-100 rounded-full mb-8 shadow-lg">
                    ...
                    <span className="text-sm font-medium text-gray-600">
                      AidPoint: New Healthcare Platform
                    </span>
                  </div>
                </div>

                <h1
                  className="text-5xl md:text-6xl font-extrabold mb-6 leading-tight opacity-0 animate-fade-in text-gray-800"
                ...
                <p
                  className="text-xl text-gray-600 mb-8 max-w-lg opacity-0 animate-fade-in"
                  style={{ animationDelay: "0.2s" }}
                >
                  Connect with trusted hospitals and doctors instantly.
                  Experience the future of healthcare with AI-powered booking
                ...
                >
                  ...
                  <Link
                    to="/register"
                    className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center transform hover:scale-105"
                  >
                    Get Started Free
                    <ArrowRight className="h-5 w-5 ml-2 group-hover:translate-x-1 transition-transform" />
                  </Link>
                        ...
                        <div className="flex-1 relative overflow-hidden p-4">
                          ...
                          <div className="backdrop-blur-xl bg-white/80 border border-blue-100 rounded-xl p-4 relative overflow-hidden h-32">
                            ...
                            <div className="absolute inset-0 p-4">
                              ...
                              <div
                                className="absolute top-10 right-8 w-2 h-2 bg-green-500 rounded-full animate-pulse"
                                style={{ animationDelay: "0.5s" }}
                              ></div>
                              <div
                                className="absolute bottom-8 left-12 w-2 h-2 bg-purple-500 rounded-full animate-pulse"
                                style={{ animationDelay: "1s" }}
                              ></div>
                              <div
                                className="absolute bottom-6 right-6 w-2 h-2 bg-red-500 rounded-full animate-pulse"
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                ...
                platform designed for patients, doctors, and hospitals.
              </p>
            </div>
          ...
          <div className="container mx-auto max-w-6xl relative z-10">
            <div className="bg-gradient-to-r from-blue-600 to-purple-800 rounded-2xl shadow-xl p-10 md:p-16 text-center">
              ...
              <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
                Join our growing community of patients and healthcare providers
                who are experiencing the future of healthcare management.
              </p>
      ...
      <footer className="py-12 px-6 bg-white/80 backdrop-blur-sm border-t border-gray-200">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 text-center text-gray-600 text-sm">
            © {new Date().getFullYear()} AidPoint. Transforming healthcare, one
