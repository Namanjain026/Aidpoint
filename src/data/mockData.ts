...
export const mockHospitals: Hospital[] = [
  ...
  city: 'Jaipur',
    ...
    lat: 26.9150,
    lng: 75.8120,
    facilities: ['ICU', 'Emergency', 'Radiology', 'Lab'],
  },
  {
    id: '2',
    name: 'St. Mary Medical Center',
  ...
  city: 'Ajmer',
    ...
    lat: 26.4499,
    lng: 74.6399,
    facilities: ['ICU', 'Emergency', 'Pediatric Ward'],
  },
  {
    id: '3',
    name: 'Metro Health Institute',
    ...
    lat: 41.8781,
    lng: -87.6298,
    facilities: ['ICU', 'Radiology', 'Surgical Suite'],
  },
  {
    id: '4',
    name: 'Jaipur City Hospital',
    location: 'Near Sanganer Road, Sector 12',
    city: 'Jaipur',
    specializations: ['General Medicine', 'ENT', 'Orthopedics', 'Emergency Medicine'],
    rating: 4.4,
    totalBeds: 250,
    availableBeds: 34,
    image: 'https://images.unsplash.com/photo-1551076805-e1869033e561?w=400',
    phone: '+91 141 1234567',
    email: 'contact@jaipurcityhospital.in',
    description: 'Leading multispecialty hospital in Jaipur offering 24/7 emergency services and specialized care.',
    acceptedInsurance: ['LIC', 'Star Health', 'Apollo'],
    pricing: {
      consultation: 800,
      emergency: 2000,
      surgery: 25000,
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: 'Excellent service and helpful staff.',
        date: '2024-05-10',
      },
    ],
    lat: 26.9124,
